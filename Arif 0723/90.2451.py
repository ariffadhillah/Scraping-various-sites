...
baseurl = 'https://www.bcu.gub.uy/Servicios-Financieros-SSF/Paginas/empresas_Seguros.aspx'
    ...
    try:
        ...
        for item in find_tables:
            ...
            for name_, title_ in zip(names, title_staff):
                ...
                data.append(data_90_2451)
                print('Saving', data_90_2451['Name'])

                fields = ['Name', 'Personal Superior' , 'Company Name' , 'Link Page']
                filename = '90.2451.csv'
