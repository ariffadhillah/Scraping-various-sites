...
baseurl = 'https://www.bcu.gub.uy/Servicios-Financieros-SSF/Paginas/emp_Serv_Fin_Lst.aspx'
    ...
    try:
        ...
        for item in find_tables:
            ...
            for name_, title_ in zip(names, title_staff):
                ...
                data.append(data_90_2449)
                print('Saving', data_90_2449['Name'])

                fields = ['Name', 'Personal Superior' , 'Company Name' , 'Link Page']
                filename = '90.2449.csv'
