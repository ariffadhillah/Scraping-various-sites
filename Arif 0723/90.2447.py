...
baseurl = 'https://www.bcu.gub.uy/Servicios-Financieros-SSF/Paginas/coo_Int_Fin_Lst.aspx'

headers = {
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36 Edg/115.0.1901.183',
    'Cookie': 'ckpersistweb-20480=ENBEABAKFAAA; _gid=GA1.3.2137570847.1690193291; WSS_FullScreenMode=false; _ga_M4Q8MD19NL=GS1.1.1690380766.9.1.1690384867.0.0.0; _ga=GA1.3.301577954.1690193289; _gat_gtag_UA_32096954_1=1'
}
    ...
    try:    
        ...
        for item in find_tables:
            ...
            for name_, title_ in zip(names, title_staff):
                ...
                data.append(data_90_2447)
                print('Saving', data_90_2447['Name'])

                fields = ['Name', 'Personal Superior' , 'Company Name' , 'Link Page']
                filename = '90.2447.csv'
