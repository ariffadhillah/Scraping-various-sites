...
baseurl = 'https://www.bcu.gub.uy/Servicios-Financieros-SSF/Paginas/emp_admin_cred.aspx'
...
for detailsPage in url:
    ...
    for item in find_tables:
        ...
        for name_, title_ in zip(names, title_staff):
            ...
            data.append(data_90_2448)
            print('Saving', data_90_2448['Name'])

            fields = ['Name', 'Personal Superior' , 'Company Name' , 'Link Page']
            filename = '90.2448.csv'
