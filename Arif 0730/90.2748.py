...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/1401'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2748)
        print('Saving', data_90_2748['Broker Names'], data_90_2748['Broker Filer Code'])
