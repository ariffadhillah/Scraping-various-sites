...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/2781'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2759)
        print('Saving', data_90_2759['Broker Names'], data_90_2759['Broker Filer Code'])
