...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/2604'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2746)
        print('Saving', data_90_2746['Broker Names'], data_90_2746['Broker Filer Code'])
