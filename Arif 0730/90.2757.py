...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/3019'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2757)
        print('Saving', data_90_2757['Broker Names'], data_90_2757['Broker Filer Code'])
