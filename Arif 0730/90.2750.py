...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/0211'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2750)
        print('Saving', data_90_2750['Broker Names'], data_90_2750['Broker Filer Code'])
