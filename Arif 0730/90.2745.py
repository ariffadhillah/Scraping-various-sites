...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/2902'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2745)
        print('Saving', data_90_2745['Broker Names'], data_90_2745['Broker Filer Code'])
