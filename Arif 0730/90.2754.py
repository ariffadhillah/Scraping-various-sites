...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/2721'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2754)
        print('Saving', data_90_2754['Broker Names'], data_90_2754['Broker Filer Code'])
