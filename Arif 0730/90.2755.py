...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/3317'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2755)
        print('Saving', data_90_2755['Broker Names'], data_90_2755['Broker Filer Code'])
