...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/2506'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2758)
        print('Saving', data_90_2758['Broker Names'], data_90_2758['Broker Filer Code'])
