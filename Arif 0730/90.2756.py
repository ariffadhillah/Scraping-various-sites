...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/1808'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2756)
        print('Saving', data_90_2756['Broker Names'], data_90_2756['Broker Filer Code'])
