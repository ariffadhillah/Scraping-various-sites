...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/5504'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2752)
        print('Saving', data_90_2752['Broker Names'], data_90_2752['Broker Filer Code'])
