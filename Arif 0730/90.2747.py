...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/3420'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2747)
        print('Saving', data_90_2747['Broker Names'], data_90_2747['Broker Filer Code'])
