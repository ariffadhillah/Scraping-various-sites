...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/0701'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2751)
        print('Saving', data_90_2751['Broker Names'], data_90_2751['Broker Filer Code'])
