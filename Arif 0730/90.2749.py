...
baseurl = 'https://www.cbp.gov/about/contact/find-broker-by-port/3406'
...
while True:
    ...
    for itemLINK in listItems:
        ...
        data.append(data_90_2749)
        print('Saving', data_90_2749['Broker Names'], data_90_2749['Broker Filer Code'])
