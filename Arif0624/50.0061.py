...
with open(filename, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for x in range(1, 314):
        offset = (x - 1) * 15
        url = f'https://journaldemonaco.gouv.mc/content/search/(offset)/{offset}?SearchText=&activeFacets[attr_theme_s:Th%C3%A8mes]=Extraits%20Judiciaires&activeFacets[attr_category_s:Cat%C3%A9gories]=Insertions%20l%C3%A9gales%20et%20Annonces&activeFacets[article_jdm/category:Cat%C3%A9gories]=Insertions%20l%C3%A9gales%20et%20Annonces&filter[]=attr_theme_s:%22Extraits%20Judiciaires%22&filter[]=attr_category_s:%22Insertions%20l%C3%A9gales%20et%20Annonces%22&sort=published_desc&page_limit=15'
        ...
        for pageURL, titleLink in pageItem:
            ...
            if urlviewthejournalinPDFformat:
                ...
                data.append(data_50_0061)
                print('Saving', data_50_0061['Title Link'], data_50_0061['Title Summary / Content'])
