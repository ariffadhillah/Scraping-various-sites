...
searcH = soup.find_all('ol', class_='caption weight-medium list-nogap mar-bot-0')[4]
for itemLINK in searcH:
    for itemURL in itemLINK.find_all('a', href=True):
        ...
        data_100_0036 = {
            ...
            'Notification': "Other Commissioner’s Orders"            
        }
        print('Saving', data_100_0036['Title'])        
        data.append(data_100_0036)
