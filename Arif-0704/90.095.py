...
baseurl = 'https://eservices.mas.gov.sg/fid/institution?sector=Financial%20Advisory&'
headers = {
...
for x in range(1, 100):
    ...
    for item in resultList.find_all('a', class_='', href=True):
        ...
        data.append(data_90_095)
        print('Saving', data_90_095['Name'], data_90_095['Company Name'])
