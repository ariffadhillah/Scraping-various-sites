...
for x in range(1, 300):
    ...
    for item in resultList.find_all('a', class_='', href=True):
        ...
        data.append(data_90_0949)
        print('Saving', data_90_0949['Name'], data_90_0949['Company Name'])
