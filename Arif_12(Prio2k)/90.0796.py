...
while page <= max_page:
    time.sleep(2)    
    url  = f"{base_url}page={page}&size=20&st=advanced&entType=EMI&sort=entiteType,asc&sort=entiteName,asc"
    print(url)
        ...
        for info_API in data_API:
            ...
            try:
                ...
                data_save = {
                    ...
                    'Link to Firm Details' : 'https://edesk.apps.cssf.lu/search-entities/entite/details/' + str(entiteId) + '?lng=en&q=&st=advanced&entType=EMI'
                }
