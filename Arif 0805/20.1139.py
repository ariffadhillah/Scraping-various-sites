...
url = 'http://www.bvi.gov.vg/ministry/premiers-office-0'
...
fields = ['Names', 'Roles', 'Department Contact Information' , 'Address Office' , 'Business Office Hours' , 'Telephone Office']
filename = '20.1139.csv'
...
name3 = panels.find_all('div', class_='field-item even')[2].text.strip().replace('Assistant Secretary','').replace('\n','')
...
roles3 = panels.find_all('div', class_='field-item even')[2].text.strip().replace('Malvern Brathwaite','').replace('\n','')
...
for i in range(len(names_list)):
    ...
    data.append(data_20_1139)
    print('Saving', data_20_1139['Names'])
