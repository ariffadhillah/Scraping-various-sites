...
url = 'https://www.judicial.ky/judicial-administration/magistrates'
    ...
    for title_div in title_divs:
        ...
        for name_anchor in name_anchors:
            ...
            if title_name_pair not in titles_and_names_seen:
                ...
                data.append(data_20_1151)
                print('Saving', data_20_1151['Names'],data_20_1151['Titles'],data_20_1151['PII'])
