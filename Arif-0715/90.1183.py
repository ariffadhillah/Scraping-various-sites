...
filename = '90.1183.csv'
data = []

r = requests.get(baseurl, headers=headers)
soup = BeautifulSoup(r.content, 'lxml')

panelGroups = soup.find_all('div', class_='panel-group')[2]
...
for panelGroup in panelGroups:
    ...
    for cardItem in cardItem:
        ...
        data_90_1183 = {
            ...
            'Email' : email,
            'List Name': 'Insurance Sub Agents'
        }

        data.append(data_90_1183)
        print('Saving', data_90_1183['Name'])
