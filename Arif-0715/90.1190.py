...
baseurl = 'https://fsaseychelles.sc/regulated-entities/gambling'
headers = {
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.79'
}

fields = ['Name' ,'Company Name', 'Email' , 'Address', 'List Name']
filename = '90.1190.csv'
data = []

r = requests.get(baseurl, headers=headers)
soup = BeautifulSoup(r.content, 'lxml')

panelGroups = soup.find_all('div', class_='panel-group')[1]
...
for panelGroup in panelGroups:
    ...
    for cardItem in cardItem:
        ...
        data_90_1190 = {
            ...
            'Email' : email,
            'Address' : addres,
            'List Name': 'Slot Machine'
        }

        data.append(data_90_1190)
        print('Saving', data_90_1190['Company Name'])
