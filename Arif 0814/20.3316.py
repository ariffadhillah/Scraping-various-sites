...
url = 'https://www.usitc.gov/alj_bios'
...
for bioDetail, roles in list_item:  
    ...
    find_section_p = soup.find('div', class_='clearfix text-formatted field field--name-field-bio-summary field--type-text-with-summary field--label-hidden field__item').text.strip()
