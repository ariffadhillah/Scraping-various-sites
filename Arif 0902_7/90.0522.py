...
fields = ['Company Name' , 'REGAFI Identifier' , 'Trade Name' , 'National Identifier (SIREN number for French entities)' , 'LEI' , 'Bank Code' , 'Category' , 'Institution Type' , 'Status' ]
filename = '90.0522.csv'

base_url = 'https://www.regafi.fr/spip.php?page=results&type=advanced&id_secteur=3&lang=en&denomination=&siren=&cib=&bic=&nom=&siren_agent=&num=&cat=01-TBR07&retrait=0'
    ...
    for find_tr in find_table.find_all('tr')[1:]:
        ...
        if find_td:
            ...
            data_save = {
                ...
                'National Identifier (SIREN number for French entities)' : siren_or_unique_identification_number,
                'LEI' : lEI_,
                'Bank Code' : bank_code,
                'Category' : category,
