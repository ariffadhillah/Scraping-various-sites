...
url = 'http://www.courtswv.gov/supreme-court/docs/spring2014/'
...
with open('50.1133.csv', 'w', newline='', encoding='utf-8') as csvfile:
    ...
    base_url2 = "http://www.courtswv.gov/supreme-court/docs/spring2014/"
    ...
    for find_tr in find_table.find_all('tr'):
        ...
        if len(td_list) >= 5:  
            ...
            if caseName_a:
                ...
                if caseName_url.startswith("../../memo-decisions/spring2014/"):
                    caseName_url = base_url1 + caseName_url.replace("../../memo-decisions/spring2014/", "")
                    print(caseName_url)
                else:
