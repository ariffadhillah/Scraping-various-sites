...
url = 'http://www.courtswv.gov/supreme-court/docs/spring2019'
...
with open('50.1138.csv', 'w', newline='', encoding='utf-8') as csvfile:
    ...
    base_url1 = "https://www.courtswv.gov/supreme-court/memo-decisions/spring2019/"
    base_url2 = "http://www.courtswv.gov/supreme-court/docs/spring2019/"
    ...
    for find_tr in find_table.find_all('tr'):
        ...
        if len(td_list) >= 5:  
            ...
            if caseName_a:
                ...
                if caseName_url.startswith("../../memo-decisions/spring2019/"):
                    caseName_url = base_url1 + caseName_url.replace("../../memo-decisions/spring2019/", "")
                    print(caseName_url)
                else:
