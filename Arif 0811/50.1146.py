...
url = 'http://www.courtswv.gov/supreme-court/docs/fall2004'
...
with open('50.1146.csv', 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for find_tr in find_table.find_all('tr'):
        ...
        if len(td_list) >= 3:  
            ...
            if caseName_url:
                caseNameUrl = 'www.courtswv.gov/supreme-court/docs/fall2004/' + caseName_url.replace('.htm','.pdf')
