...
url = 'https://www.rree.go.cr/?sec=misiones&cat=deCR&cont=525&id=108&pais=DE'
...
for infobox in infoboxes:
    name = infobox.find('span', class_='metaTitle').text
    title = infobox.find('span', class_='metaQuote').text
