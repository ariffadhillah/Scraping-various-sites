...
baseurl = 'https://www.bcu.gub.uy/Servicios-Financieros-SSF/Paginas/rep_Ent_Fin_Ext_Lst.aspx'
    ...
    try:
        ...
        for item in find_tables:
            ...
            for name_, title_ in zip(names, title_staff):
                ...
                data.append(data_90_2450)
                print('Saving', data_90_2450['Name'])

                fields = ['Name', 'Personal Superior' , 'Company Name' , 'Link Page']
                filename = '90.2450.csv'
